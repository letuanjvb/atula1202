          ...
          {signIn ? (
            ...
            <>
              ...
              <div className="loginScreen_input">
                ...
                <button className="loginScreen_getStarted"> Tài khoản khách</button>
              </div>
            </>
          )}
        </div>
      ...
      <div className="loginScreen_info">
        <div className="loginScreen_animationcard_container">
          <div className="loginScreen_animationcard_info">
            ...
            <h2>
              Bạn không có tài khoản? Bạn là sinh viên không có xèn? Bạn có thể xem phim chất lượng
              thấp hoàn toàn miễn phí. Bạn giàu, hãy mua VIP và xem phim với chất lượng Full HD 4k.
            </h2>
          </div>
          <div className="loginScreen_animationcard_videobg">
            <img src={Money} alt="" />
